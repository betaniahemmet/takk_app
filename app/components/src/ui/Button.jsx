...
export default function Button({ as: Tag = "button", variant = "primary", className = "", ...props }) {
  ...
  const variants = {
    ...
    outline:  "bg-transparent border border-gray-300 text-gray-900 hover:bg-black/5 dark:border-white/20 dark:text-white dark:hover:bg-white/10",
    secondary:"bg-slate-700 text-white hover:bg-slate-800 dark:bg-slate-600 dark:hover:bg-slate-700",
